...
const GridHeader = ({ columns, showRowNumCol, showRowCheckboxCol, options, reducer, editedRows, }) => {
    ...
    return (_jsxs("thead", { className: "nh-grid-header", children: [_jsxs("tr", { className: "nh-grid-header-row", children: [editedRows && Object.keys(editedRows).length > 0 && (_jsx("th", { className: "nh-grid-header-cell nh-action-header", children: _jsxs("div", { style: { display: "flex", gap: "1px", justifyContent: "center" }, children: [_jsx("button", { className: "nh-btn nh-btn-apply", onClick: reducer.applyAllChanges, children: _jsx(FaCheck, {}) }), _jsx("button", { className: "nh-btn nh-btn-reset", onClick: reducer.resetAllChanges, children: _jsx(FaUndo, {}) })] }) })), showRowNumCol && _jsx("th", { className: "nh-grid-header-cell", children: "No." }), showRowCheckboxCol && _jsx("th", { className: "nh-grid-header-cell", children: "\u2714" }), columns.map((col) => {
                        var _a;
                        return (_jsx("th", { className: `nh-grid-header-cell ${col.sticky === "left" ? "sticky-left" : ""} ${col.sticky === "right" ? "sticky-right" : ""}`, style: { width: col.width ? `${col.width}px` : "auto", textAlign: col.align || "left" }, title: col.tooltip, onContextMenu: (event) => handleContextMenu(event, col), children: _jsxs("div", { className: "nh-grid-header-content", children: [_jsx("span", { children: col.label }), col.sortable && sortedColumn === col.key && sortDirection !== null && (sortDirection === "asc" ?
